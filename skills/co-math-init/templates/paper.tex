...
\newcommand{\unproven}[1]{%
  ...
  \gappto\unprovenlist{\item #1\par}%
}
...
provenance of each contribution. Items flagged \texttt{\textbackslash unproven}
are explicitly unverified and listed in the appendix of open obligations.
\end{abstract}
...
\ifdefempty{\unprovenlist}{\textit{None at this stage.}}{%
\begin{itemize}
\unprovenlist
\end{itemize}}
